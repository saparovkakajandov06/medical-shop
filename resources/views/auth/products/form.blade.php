...
@isset($product)
    @section('title', 'Dermany üýtgetmek ' . $product->name)
@else
    @section('title', 'Dermany döretmek')
@endisset

@section('content')
    <div style="margin-top: 10%; color: #2c2172;" class="col-md-12">
        @isset($product)
            <h1>Dermany üýtgetmek  <b>{{ $product->name }}</b></h1>
        @else
            <h1>Derman döretmek</h1>
        @endisset
        ...
        >
            <div>
                ...
                <br>
                    <div class="input-group row">
                        <label for="name" class="col-sm-2 col-form-label">Derman ady: </label>
                        <div class="col-sm-6">
                ...
                <br>
                    <div class="input-group row">
                        <label for="description" class="col-sm-2 col-form-label">Dermanyň mazmuny: </label>
                        <div class="col-sm-6">
                ...
                <div class="input-group row">
                    <label for="category_id" class="col-sm-2 col-form-label">Dermanyň mazmuny: </label>
                    <div class="col-sm-6">
